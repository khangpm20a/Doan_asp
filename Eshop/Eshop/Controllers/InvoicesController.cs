...
namespace Eshop.Controllers
{
	public class InvoicesController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			ViewBag.NameAccount = HttpContext.Session.GetString("NameAccount");
...

		{
			...
			ViewBag.InvoiceDetails = _context.InvoiceDetails
											   .Include(i => i.Product)
											   .Where(i => i.InvoiceId == invoice.Id);

			HttpContext.Session.SetString("NameAccount", invoice.Account.FullName);
		...
		public async Task<IActionResult> UserIndex()
		{
			...
			var eshopContext = _context.Invoices.Include(i => i.Account).Where(a => a.AccountId == id);
			return View(await eshopContext.ToListAsync());
		}
		public async Task<IActionResult> UserDetails(int? id)
		{
			...
			var invoice = _context.InvoiceDetails
				.Include(i => i.Invoice).Include(i => i.Product).Where(u => u.InvoiceId == id)
				.ToList();
			if (invoice == null)
			{
				return NotFound();
